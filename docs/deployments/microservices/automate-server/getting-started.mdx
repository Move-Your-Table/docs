...
- [Rust](https://www.rust-lang.org/tools/install)
  ...
  :::tip Rust *technically* not required
  
  While this is listed within the requirements, you'll only need this if you choose to run your code locally. Docker takes care of Rust!
